...
import arcade
def main():
    our_color = arcade.color.LAVENDER,arcade.color.BLUE,arcade.color.GREEN,arcade.color.BOSTON_UNIVERSITY_RED,arcade.color.ORANGE,arcade.color.ATOMIC_TANGERINE,arcade.color.YELLOW
    arcade.open_window(800,600,"file editing")
    joke_open = open("fun.txt", "r")
